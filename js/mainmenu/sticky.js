    ...
    jQuery(function(t) {
        ...
        return K = t(window), z = t(document), window.App = {}, n = t("body, html"), o = t("#header"), s = t("#headerPush"), i = t("#footer"), O = "easeInOutExpo", k = "/wp-content/themes/KIND", b = 39, C = 37, P = 38, v = 40, y = 27, N = navigator.userAgent, q = N.match(/(Android|iPhone|BlackBerry|Opera Mini)/i), A = N.match(/(iPad|Kindle)/i), E = function() {
            ...
            return t.prototype.autoplay = function() {
                ...
                var n, e, i = this;
                if (t !== this.current)
                    return null != this.interval && this.clear(), t > this.max && (t = 0), 0 > t && (t = this.max), this.$slides.removeClass("active"), this.$slides.eq(t).addClass("active"), this.$h2 = this.$slides.eq(t).find("h2"), setTimeout(function() {
                ...
                return n = 0, i = this.$h2.data().sequences.split(","), t = e = i[n], r = function(r) {
                    ...
                    for (a = e.split(" "), n = t.split(" "), p = "", l = 0, c = f = 0, g = a.length; g > f; c=++f)
                        d = a[c], d === n[c] && (l++, l > c && (p += d + " "));
            ...
            return n.prototype.checkPosition = function(n) {
                ...
                if (null != this.$timeline)
                    return t = this.$timeline.outerHeight(), t -= this.$timeline.find("article:visible:last-child").outerHeight(), this.$fx.css({
                        height: t
                    }), this
            }, n
